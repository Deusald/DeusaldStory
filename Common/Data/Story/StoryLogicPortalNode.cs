...
namespace DeusaldStoryCommon
{
    ...
    /// <b>value</b> and is <b>one-in / many-out</b>: a single <see cref="InPoint"/> — a generic <i>Data</i> input that
    /// accepts any value signal (Text, Icon, Variable or Constant) — receives the value from a producing output, and
    /// any number of <see cref="OutPoints"/> re-emit it to consuming inputs, keeping the inner graph free of long
    /// crossing wires. Each out adopts the concrete type of whatever is wired into the in. Rendering resolves a
    ...
    public class StoryLogicPortalNode
    {
        ...
        /// <summary>The single "portal in" node — a value of any signal type arrives here from a producing output.</summary>
